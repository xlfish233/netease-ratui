...
pub(super) fn prev_play_mode(m: crate::app::PlayMode) -> crate::app::PlayMode {
    use crate::app::PlayMode;
    match m {
...
pub(super) fn play_mode_label(m: crate::app::PlayMode) -> &'static str {
    use crate::app::PlayMode;
    match m {
...
pub(super) fn seek_relative(
    app: &mut App,
    tx_audio: &std::sync::mpsc::Sender<crate::audio_worker::AudioCommand>,
    delta_ms: i64,
) {
